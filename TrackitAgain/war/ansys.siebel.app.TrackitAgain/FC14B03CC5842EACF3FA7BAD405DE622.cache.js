...
var $strongName = 'FC14B03CC5842EACF3FA7BAD405DE622';
...
function TrackitAgainGadgetImpl_0(){
  ...
  $addDomHandler(btnTrackit, new TrackitAgain$1_0, ($clinit_33() , $clinit_33() , TYPE));
  $removeFromParent(btnTrackit);
  beforeIndex = rootPanel.children.size;
  rootPanel.setWidgetPositionImpl(btnTrackit, 171, 165);
  ...
  textBox_1.element.style['width'] = '227px';
  textBox_1.element.style['height'] = '24px';
  richTextArea = new RichTextArea_0;
  $removeFromParent(richTextArea);
  beforeIndex_2 = rootPanel.children.size;
  rootPanel.setWidgetPositionImpl(richTextArea, 87, 94);
  $insert(rootPanel, richTextArea, rootPanel.element, beforeIndex_2);
  richTextArea.element.style['width'] = '223px';
...
function getDirectionOnElement(elem){
  ...
  if ($equalsIgnoreCase('rtl', dirPropertyValue)) {
    return $clinit_83() , RTL;
  }
   else if ($equalsIgnoreCase('ltr', dirPropertyValue)) {
    return $clinit_83() , LTR;
  }
  return $clinit_83() , DEFAULT;
}
...
function setDirectionOnElement(elem, direction){
  switch (direction.ordinal) {
    ...
    case 2:
      {
        getDirectionOnElement(elem) != ($clinit_83() , DEFAULT) && (elem['dir'] = '' , undefined);
        break;
      }
...
function $onAttach_0(this$static){
  ...
  tabIndex = $getTabIndex(this$static.element);
...
function $hookEvents(this$static){
  ...
  wnd.onfocus = function(evt){
    elem.__listener && dispatchEvent_1(evt, elem, elem.__listener);
  }
  ;
